	...
	<div id="wrap" class="container">
		...
		<nav class="d-flex bg-danger justify-content-center align-items-center">
			<ul class="nav nav-fill w-100">
				...
				<li class="nav-item"><a class="nav-link" href="/lesson02/quiz09_1.jsp?type=jisang">지상파</a></li>
				<li class="nav-item"><a class="nav-link" href="/lesson02/quiz09_1.jsp?type=drama">드라마</a></li>
				<li class="nav-item"><a class="nav-link" href="/lesson02/quiz09_1.jsp?type=variety">예능</a></li>
				<li class="nav-item"><a class="nav-link" href="/lesson02/quiz09_1.jsp?type=movie">영화</a></li>
				<li class="nav-item"><a class="nav-link" href="/lesson02/quiz09_1.jsp?type=sports">스포츠</a></li>
			</ul>	
		</nav>
