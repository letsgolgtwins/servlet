...
<body>
	...
	<div id="wrap" class="container">
		...
		<section class="contents">
			<div class="up d-flex border border-success p-3">
					<div class="upoutside d-flex bg-white">
						<div class="mt-2 ml-2 mb-2">
							<img width="180" height="180" alt="아티스트사진"
				...
				<table class="table text-center">
					...
					<tbody>
						...
						<tr>
							...
							<td><a class="text-info" href="/lesson02/quiz10_1.jsp?id=<%=musicList.get(i).get("id")%>"><%=musicList.get(i).get("title")%></a></td>
